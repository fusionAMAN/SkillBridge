...
export const googleAuthCallback = passport.authenticate("google", {
  failureRedirect: "https://delicate-mochi-3c8476.netlify.app/login",
  session: false,
});
...
export const handleGoogleLoginCallback = asyncHandler(async (req, res) => {
  ...
  if (existingUser) {
    ...
    return res.redirect(`https://delicate-mochi-3c8476.netlify.app/discover`);
  }
  ...
  return res.redirect("https://delicate-mochi-3c8476.netlify.app/register");
});
