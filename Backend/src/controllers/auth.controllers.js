...
export const googleAuthCallback = passport.authenticate("google", {
  failureRedirect: "https://symphonious-banoffee-acfddb.netlify.app/login",
  session: false,
});
...
export const handleGoogleLoginCallback = asyncHandler(async (req, res) => {
  ...
  if (existingUser) {
    ...
    return res.redirect(`https://symphonious-banoffee-acfddb.netlify.app/discover`);
  }
  ...
  return res.redirect("https://symphonious-banoffee-acfddb.netlify.app/register");
});
